...
@Component({
  selector: 'app-vehicle-tracks',
  templateUrl: './vehicle-tracks.component.html',
  styleUrls: ['./vehicle-tracks.component.css']
})
export class VehicleTracksComponent implements OnInit {
